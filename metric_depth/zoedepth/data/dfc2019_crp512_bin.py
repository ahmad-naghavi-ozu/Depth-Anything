"""
DFC2019_crp512_bin Remote Sensing Dataset for Height Estimation
...
class DFC2019crp512bin(Dataset):
    """DFC2019_crp512_bin Dataset for remote sensing height estimation"""
    
    def __init__(self, data_dir_root, split='train', resize_shape=None):
        """
        Args:
            data_dir_root: Root directory of DFC2019_crp512_bin dataset
        ...
        print(f"DFC2019_crp512_bin {split} set: {len(self.rgb_files)} samples")
...
def get_dfc2019_crp512_bin_loader(data_dir_root, split='train', batch_size=4, 
                              num_workers=4, resize_shape=(512, 512), **kwargs):
    """Create DataLoader for DFC2019_crp512_bin"""
    dataset = DFC2019crp512bin(
